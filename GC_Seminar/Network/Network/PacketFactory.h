...
#include "../flatbuffers/Data/InGameUserData_generated.h"
#include "../flatbuffers/Data/WorldData_generated.h"
...
public:
	...
	static GamePacket createEnterStartingPacket(int map, const std::vector<std::tuple<int, std::string, int>>& users);
