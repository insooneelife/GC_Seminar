...
struct GLRenderPoints
{
    ...
    void Flush()
	{
		...
		Camera::getInstance().BuildProjectionMatrix(proj, 0.0f);
...
struct GLRenderLines
{
    ...
    void Flush()
	{
		...
		float32 proj[16] = { 0.0f };
		Camera::getInstance().BuildProjectionMatrix(proj, 0.1f);
...
struct GLRenderTriangles
{
    ...
    void Flush()
	{
		...
		float32 proj[16] = { 0.0f };
		Camera::getInstance().BuildProjectionMatrix(proj, 0.2f);
