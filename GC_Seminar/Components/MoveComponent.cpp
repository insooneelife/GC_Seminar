...
int MoveComponent::makeDirection(int x, int y, int nu, int de)
{
...
MoveComponent::MoveComponent(IMoveComponent& entity, float moveSpeed, const Vec2& destination, bool hasDestination)
	:
	_owner(entity),
